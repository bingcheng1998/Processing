...
static float testNum = 121.21;//接收到的第一个数据作为验证值
...
void setup() {
  size(1000, 563);
  String TXTname = "Data"+"-" + str(day()) + "-" + str(hour()) + "-" + str(minute());
  output = createWriter(TXTname+".txt");//程序文件夹内形成数据的TXT文件。
  output.println("year: " + str(year()) + "\tmonth: " + str(month()) + "\tday: " 
  + str(day()) + "\thour: " + str(hour()) + "\tminute: " + str(minute()) + "\n\n");
  output.println("\nx\t"+"y\t"+"z\t");
  //String[] serialList = new String [20];
